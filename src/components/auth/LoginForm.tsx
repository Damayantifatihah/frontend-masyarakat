        ...
        <div className="relative z-10 w-1/2 hidden lg:flex flex-col justify-center pl-20">
          <div className="max-w-xs">
            ...
            <h2 className="text-[40px] font-extrabold text-[#E8734A] leading-tight mb-4">
              Suaramu penting<br />untuk kotamu.
            </h2>

            <p className="text-[#c45e33] text-[15px] leading-relaxed">
              Laporkan masalah di sekitarmu dan<br />
          ...
          <div className="w-full max-w-[420px]">
           ...
           <form onSubmit={handleLogin} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-white font-semibold text-[14px]">Email</label>
               <input
                type="email"
                value={email}
              ...
              {/* Password */}
              <div className="flex flex-col gap-1.5">
                <label className="text-white font-semibold text-[14px]">Kata Sandi</label>
                ...
                <div className="text-right">
                  <Link href="/forgot-password" className="text-[12px] text-white/70 hover:text-white transition">
                    Lupa kata sandi?
                  </Link>
                </div>
              </div>
            ...
            <div className="flex items-center gap-3 my-6">
              ...
              <span className="text-white/60 text-[12px] whitespace-nowrap">atau lanjutkan dengan</span>
              <div className="flex-1 h-px bg-white/30" />
            </div>
            ...
            <button className="w-full h-[52px] bg-white rounded-xl flex items-center justify-center gap-3 shadow-md hover:scale-[1.02] transition-all duration-300">
              <svg width="20" height="20" viewBox="0 0 48 48">
                <path fill="#EA4335" d="M24 9.5c3.14 0 5.95 1.08 8.17 2.85l6.1-6.1C34.46 3.03 29.5 1 24 1 14.82 1 7.07 6.48 3.64 14.22l7.19 5.58C12.6 13.35 17.85 9.5 24 9.5z"/>
                <path fill="#4285F4" d="M46.52 24.5c0-1.64-.15-3.22-.43-4.75H24v9h12.68c-.55 2.97-2.2 5.48-4.67 7.17l7.18 5.57C43.54 37.45 46.52 31.4 46.52 24.5z"/>
                <path fill="#FBBC05" d="M10.83 28.42A14.6 14.6 0 019.5 24c0-1.54.26-3.03.72-4.42L3.03 14C1.1 17.74 0 21.74 0 26c0 4.26 1.1 8.26 3.03 12l7.8-6.05z"/>
                <path fill="#34A853" d="M24 47c5.5 0 10.12-1.82 13.5-4.94l-7.18-5.57C28.46 38.13 26.36 39 24 39c-6.15 0-11.4-3.85-13.17-9.28l-7.8 6.05C6.97 43.52 14.82 47 24 47z"/>
              </svg>
              <span className="text-[14px] font-semibold text-gray-700">Masuk dengan Google</span>
            </button>
